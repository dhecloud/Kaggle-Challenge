...
class rsna(imdb):
  def __init__(self, image_set, devkit_path=None):
    ...
    assert os.path.exists(self._devkit_path), \
      'RSNA path does not exist: {}'.format(self._devkit_path)
  ...
  def _load_rsna_annotation(self, index):
    """
    ...
    for i in range(num_objs):
      # Make pixel indexes 0-based (i removed the -1)
      x1 = dcm_data['boxes'][i][1]  #xmin
